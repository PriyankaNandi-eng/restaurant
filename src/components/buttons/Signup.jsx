    ...
    return (
        <div>
            ...
            <button type="button" className="btn btn-outline-dark  ms-auto" data-bs-toggle="modal" data-bs-target="#signupModal">
                <span className="fa fa-user-plus m-1"></span> Register
            </button>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <button className="btn btn-primary w-100 mb-4">
                                <span className="fab fa-google me-2"></span> Sign up With Google
                            </button>
                            <button className="btn btn-primary w-100 mb-4">
                                <span className="fab fa-facebook me-2"></span> Sign up With Facebook
                            </button>
                            <form>
                                <div className="mb-3">
