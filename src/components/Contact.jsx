        ...
        <div>
            <div className="container mb-5">
                <div className="row">
                    ...
                    <h1 className='text-dark fw-bold'>Order Your Food</h1>
                ...
                <div className="row">
                    ...
                    <div className="col-md-6">
                        <form action="https://formspree.io/f/xoqbqznd"
                                       method="POST"
                                      className="form-control">
                            <div className="mb-3">
                                <label for="exampleForm" className="form-label">Full Name</label>
                                <input type="text"  name="username" className="form-control" id="exampleForm" placeholder="John Smith"/>
</div>
                            <div className="mb-3">
